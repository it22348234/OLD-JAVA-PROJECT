...
/**
 * Servlet implementation class StaffMemberUpdateProfileServlet
 */
@WebServlet("/StaffMemberUpdateProfileServlet")
public class StaffMemberUpdateProfileServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StaffMemberUpdateProfileServlet() {
        super();
