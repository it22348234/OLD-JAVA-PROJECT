...
/**
 * Servlet implementation class StaffMemberEditProfileServlet
 */
@WebServlet("/StaffMemberEditProfileServlet")
public class StaffMemberEditProfileServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StaffMemberEditProfileServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/smEditProfile.jsp");
