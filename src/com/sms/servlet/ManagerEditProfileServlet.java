...
/**
 * Servlet implementation class ManagerEditProfileServlet
 */
@WebServlet("/ManagerEditProfileServlet")
public class ManagerEditProfileServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/mgrEditProfile.jsp");
