...
/**
 * Servlet implementation class ViewStaffMemberServlet
 */
@WebServlet("/viewStaffMemberServlet")
public class ViewStaffMemberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ViewStaffMemberServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/viewStaffMember.jsp");
