...
<head>
	...
	<title>SuperStaff | Error 500</title>
	<link rel="icon" type="image/x-icon" href="images/logoFavicon.ico">

	<link rel="stylesheet" type="text/css" href="css/error-500.css">
</head>
<body>
	...
	<section class="error-container">
		<svg id="500_Bill" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="300px" width="1000px" viewBox="-8.5 9.5 560 250">
		    <defs>
	...
	<div class="link-container">
	  <a href="index.jsp" class="more-link">Go back home</a>
	</div>
