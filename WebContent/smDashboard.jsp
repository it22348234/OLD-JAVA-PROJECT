...
<head>
  <meta charset="UTF-8">
  <title>SuperStaff | Staff Member Dashboard</title>
...
<div class="dashboard">
	<aside class="top-wrap">
		...
		<div class="search">
			<label for="search">
				<form action="staffMemberSearch" method="post">
		          ...
		          <datalist id="toList">
		              ...
		              <option value="wages list"></option>
	...
	<header class="menu-wrap">
		<figure class="user">
			<div class="user-avatar">
				<img src="images/profile.png" alt="Staff Member">
			</div>
			<figcaption>
			  	<%
			  			out.print(session.getAttribute("smUname")); 		
			  	%>
			</figcaption>
		</figure>
			...
			<section class="info-boxes">
				...
				<div class="info-box active">
					...
					<div class="box-content">
						<span class="big"><%=StaffMemberDashboardDBUtil.getPaymentCount((String)session.getAttribute("smUname"))%></span>
						Wages received
					</div>
				</div>
				...
				<div class="info-box">
					...
					<div class="box-content">
						<span class="big"><%=StaffMemberDashboardDBUtil.getFeedbackCount((String)session.getAttribute("smUname"))%></span>
						Feedbacks
					</div>
				</div>
				...
				<div class="info-box">
					...
					<div class="box-content">
						<span class="big"><%=StaffMemberDashboardDBUtil.getLeaveCount((String)session.getAttribute("smUname"))%></span>
						Leaves requested
					</div>
				</div>
				...
				<div class="info-box">
					...
					<div class="box-content">
						<span class="big"><%=StaffMemberDashboardDBUtil.getApprovedLeaveCount((String)session.getAttribute("smUname"))%></span>
						Leaves approved
					</div>
				</div>	
