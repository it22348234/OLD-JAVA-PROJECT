...
<title>SuperStaff | Edit Profile</title>
...
<body>
   ...
   <div class="container">
    ...
    <div class="content">
      ...
      <form action = "staffMemberUpdateProfile" method = "post">
        ...
        <div class="user-details">
          ...
          <input type="hidden" name="position" value="<%=sm.getPosition()%>" readonly required>
          <input type="hidden" name="salary" value="<%=sm.getSalary()%>" readonly required>

          <div class="input-box">
            <span class="details">Username</span>
            <input type="text" placeholder="Enter username" name="username" pattern="^[a-zA-Z]([._](?![._])|[a-zA-Z0-9]){3,18}[a-zA-Z0-9]$" title="Must contain at least five characters, begin with a letter and can contain only letters, numbers, period and underscore" value="<%=sm.getUsername()%>" readonly required>
          </div>
          <div class="input-box">
