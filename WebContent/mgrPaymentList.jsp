		...
		<thead>
			...
			<tbody>
				...
				<%
					...
					ArrayList<Payment> payments = iPay.getAllPayment();
				...
				<tr>
					...
					<td><c:out value="<%=pay.getPaidTo() %>" /></td>
					...
					<td><a class="button" href= "editPayment?payId=<%=pay.getPaymentID() %>" >Edit</a></td>
					<td><a class="button" href= "deletePayment?payId=<%=pay.getPaymentID() %>" >Delete</a></td>
				</tr>
			</tbody>
