...
<title>SupersStaff | Leaves List</title>
...
<div id="buttons">
  		...
  		<a href="addLeave.jsp" style="border-radius: 5px;  
  							padding: 5px 10px; 
  							font-size: 22px;  
  							text-decoration: none;  
  							margin: 20px;  
  							...
  							display: inline-block;
  							background-color: #9b59b6;
  							box-shadow: 0px 5px 0px 0px #82409D;" >ADD LEAVE</a>
		...
		<thead>
			...
			<tbody>
				...
				<%
					...
					ArrayList<Leave> leave = iLv.getLeave((String)session.getAttribute("smUname"));
				...
				<tr>
					...
					<td><a class="button" href= "editLeave?lvId=<%=lv.getLeaveID() %>" >Edit</a></td>
					<%} else { %>
					<td></td>
					<%} %>
				</tr>
